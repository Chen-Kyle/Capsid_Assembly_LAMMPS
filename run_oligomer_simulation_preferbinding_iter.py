...
def main_simulation(energy_repulsion,energy_attraction,iter_number): 
    ...
    dimer_list.append('A2B2')
    dimer_list.append('C23D23')
    dimer_list.append('C10D10')
    #ubound has native contact definitions from bound state
    ubound=mda.Universe(home_dire+'/pentamer_avg.pdb')
    ...
    simulation.saveState(f'{energy_attraction}/{iter_number}/final{energy_repulsion}_{energy_attraction}.xml')
